...
class ConstraintFunction(ABC):
    ...
    use as a constraint function, such as an Objective or its Gradient.
    ...
    def __call__(self, x, sx):
        """ Make ConstraintFunction objects callable.
        ...
        Returns:
            float: The output of this constraint for the input x (when defining
